...
async def test_endpoints_monkeypatched(monkeypatch):
    async def fake_get_all():
        return [
            {
                "id": "asv-bergedorf-lohbruegge-von-1885-e-v",
                "name": "ASV Bergedorf-Lohbrügge von 1885 e.V.",
                "url": "https://www.hfv.de/vereine/asv-bergedorf-lohbruegge-von-1885-e-v/",
            },
            {"id": "test-fc", "name": "Test FC", "url": "https://www.hfv.de/vereine/test-fc/"},
        ]

    async def fake_get_by_identifier(identifier: str):
        if identifier in ("test-fc", "Test FC"):
            return {
                ...
                "address": {
                    "full": "Musterstr. 1 12345 Hamburg",
                    "street": "Musterstr. 1",
                    "postcode": "12345",
                    "city": "Hamburg",
                },
